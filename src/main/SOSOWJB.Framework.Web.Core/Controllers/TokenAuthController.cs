...
using SOSOWJB.Framework.Authorization.Impersonation;
...
using SOSOWJB.Framework.Web.Authentication.JwtBearer;
using SOSOWJB.Framework.Web.Authentication.TwoFactor;
using SOSOWJB.Framework.Web.Models.TokenAuth;

namespace SOSOWJB.Framework.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : FrameworkControllerBase
    {
