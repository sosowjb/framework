...
using SOSOWJB.Framework.Migrations.Seed.Host;

namespace SOSOWJB.Framework.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : FrameworkAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<FrameworkDbContext> _migrator;
