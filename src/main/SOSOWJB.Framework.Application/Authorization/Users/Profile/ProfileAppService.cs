...
using SOSOWJB.Framework.Authentication.TwoFactor.Google;
using SOSOWJB.Framework.Authorization.Users.Dto;
using SOSOWJB.Framework.Authorization.Users.Profile.Cache;
using SOSOWJB.Framework.Authorization.Users.Profile.Dto;
using SOSOWJB.Framework.Friendships;
using SOSOWJB.Framework.Identity;
using SOSOWJB.Framework.Security;
using SOSOWJB.Framework.Storage;
using SOSOWJB.Framework.Timing;

namespace SOSOWJB.Framework.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : FrameworkAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("SOSOWJB.Framework",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("SOSOWJB.Framework",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
