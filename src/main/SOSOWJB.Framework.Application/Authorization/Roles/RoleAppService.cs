...
using SOSOWJB.Framework.Authorization.Permissions;
using SOSOWJB.Framework.Authorization.Permissions.Dto;
using SOSOWJB.Framework.Authorization.Roles.Dto;
...
namespace SOSOWJB.Framework.Authorization.Roles
{
    ...
    public class RoleAppService : FrameworkAppServiceBase, IRoleAppService
    {
