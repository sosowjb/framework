...
using SOSOWJB.Framework.DemoUiComponents.Dto;

namespace SOSOWJB.Framework.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : FrameworkAppServiceBase, IDemoUiComponentsAppService
    {
