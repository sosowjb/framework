...
using SOSOWJB.Framework.MultiTenancy.Demo;
...
namespace SOSOWJB.Framework.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(FrameworkConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
